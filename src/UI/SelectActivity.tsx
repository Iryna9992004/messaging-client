...
export default function SelectActivity() {
  ...
  return (
    <div ref={ref} className="relative w-fit">
      ...
      >
        <ChevronDown
          style={isOpened ? { transform: 'rotate(180deg)', stroke: '#4fbfff' } : {}}
          className="absolute top-[15px] right-[10px] h-[15px] w-[15px]"
        />
      ...
      {isOpened ? (
        <div className="absolute bg-white shadow-md p-2 rounded-lg w-[160px] top-[50px]">
          <div
            ...
            className="text-sm p-1 text-gray-500 hover:bg-gray-100 duration-500 rounded-md cursor-pointer flex items-center gap-[6px]"
          >
