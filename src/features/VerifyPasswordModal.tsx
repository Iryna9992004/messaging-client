...
export default function VerifyPasswordModal({ handleResetPassoword, handleStage }: ForgotProps) {
  ...
  return (
    <div className="w-[350px] h-fit bg-white rounded-lg p-5" onClick={(e) => e.stopPropagation()}>
      ...
      <div className="flex gap-2 justify-between mb-3">
        ...
        <input
          ...
          maxLength={1}
          value={num4}
          onChange={(e) => setNum4(e.target.value ? e.target.value : '')}
      ...
      <div className="flex flex-col mb-4 gap-[5px]">
        <div className="flex items-center gap-[5px]">
          ...
          {time !== 0 ? <div className="text-gray-500 text-sm">Send code again:</div> : null}
          <div className="text-blue-600 text-sm">00:{time < 10 ? `0${time}` : time}</div>
        </div>
      </div>
