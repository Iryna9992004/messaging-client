  ...
  return (
    ...
    >
      {stage === 'forgot-password' ? (
        <ForgotPasswordModal
          handleResetPassoword={handleResetPassoword}
      ...
      {stage === 'reset' ? (
        <ResetPassword handleResetPassoword={handleResetPassoword} handleStage={handleStage} />
      ) : null}
      {stage === 'success' ? (
        <SuccessModal handleResetPassoword={handleResetPassoword} handleStage={handleStage} />
      ) : null}
    </div>
  );
}
